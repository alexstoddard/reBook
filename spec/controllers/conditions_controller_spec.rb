  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved condition as @condition" do
        ...
        post :create, {:condition => { "description" => "invalid value" }}, valid_session
        assigns(:condition).should be_a_new(Condition)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested condition" do
        ...
        Condition.any_instance.should_receive(:update).with({ "description" => "MyString" })
        put :update, {:id => condition.to_param, :condition => { "description" => "MyString" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the condition as @condition" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Condition.any_instance.stub(:save).and_return(false)
        put :update, {:id => condition.to_param, :condition => { "description" => "invalid value" }}, valid_session
        assigns(:condition).should eq(condition)
      end
