  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved trade as @trade" do
        ...
        post :create, {:trade => { "status" => "invalid value" }}, valid_session
        assigns(:trade).should be_a_new(Trade)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested trade" do
        ...
        Trade.any_instance.should_receive(:update).with({ "status" => "MyString" })
        put :update, {:id => trade.to_param, :trade => { "status" => "MyString" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the trade as @trade" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Trade.any_instance.stub(:save).and_return(false)
        put :update, {:id => trade.to_param, :trade => { "status" => "invalid value" }}, valid_session
        assigns(:trade).should eq(trade)
      end
